...
/***/ function(module, exports, __webpack_require__) {
	...
	var _foo = __webpack_require__(5);
	...
	var _leftMenu = __webpack_require__(13);
	...
	// 或者，只是一个组件配置对象。
	// 我们晚点再讨论嵌套路由。
	var routes = [{ path: '/foo', component: Foo }, { path: '/bar', component: Bar }, { path: '/user/:id', component: User }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports={render:function (){with(this) {
	  ...
	  }, ["Go to Foo"]), " ", _m(1)]), " ", _m(2), " ", _m(3), " ", _m(4), " ", _m(5), " ", _m(6), " ", _m(7), " ", _m(8), " ", _m(9), " ", _m(10)])])
